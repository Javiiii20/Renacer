      ...
      <div className={styles.footer_container}>
        ...
        <div className={styles.social_media}>
          ...
          <div className={styles.social_icons}>
            <a href="https://www.facebook.com/ClinicaPsicologiaNuevaConcepcion" target="_blank" rel="noopener noreferrer">
              <img src="../../facebook.svg" alt="Facebook" className={styles.social_icon} />
            </a>
          </div>
        </div>
      </div>
